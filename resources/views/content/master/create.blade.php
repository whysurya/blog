                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('master.kirim.data.baru')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_kelas" value="" placeholder="nama kelas" class="form-control" id="">
                            </div>
                            <div class="form-group">
                                <label for="nama_jurusan">Nama Jurusan</label>
                                <input type="text" name="nama_jurusan" value="" placeholder="nama jurusan" class="form-control" id="">
                            </div>
                            <div class="form-group">
